package com.codeLife.init.common.param;
...
public class CodeMsg {
    ...
    public static CodeMsg FILE_NOT_FOUNT = new CodeMsg("500001", "文件不存在,请重新上传");
    ...
    // public static CodeMsg getCodeMsg(String codeParam) {
    //     CodeMsg.get
    //     CodeMsg codeMsg = CodeMsg.getCodeMsg(codeParam);
    //     return codeMsg != null ? codeMsg : SERVER_ERROR;
    // }
}
